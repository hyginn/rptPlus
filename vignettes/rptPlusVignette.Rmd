...
Tables automatically receive anchors you can link to, for example the link to Table 1 is `link\@ref(tab:tMacros)` and it appears thus: Table \@ref(tab:tMacros).
...
<!-- the "References"" section determines placement of the bibliography -->
# References
